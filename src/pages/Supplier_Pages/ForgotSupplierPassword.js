...
function ForgotSupplierPassword() {
  ...
  const handleForgotPassword = () => {
    axios
      .post("https://inventory-management-rest-api-mongo-db.onrender.com/api/suppliers/forgot-password", { email })
      .then((response) => {
  ...
  const handleResetPassword = () => {
    axios
      .post("https://inventory-management-rest-api-mongo-db.onrender.com/api/suppliers/reset-password", { newPassword, token })
      .then((response) => {
