...
function UpdateProduct() {
  ...
  const handleUpdateProduct = (productId) => {
    ...
    axios.put(`https://inventory-management-rest-api-mongo-db.onrender.com/api/products/${productId}`, { name, price }, {
      headers: {
        Authorization: `Bearer ${token}`
      }
    })
                ...
                <div className="card p-3" style={{ backgroundColor: "#f8f9fa", boxShadow: "0px 4px 8px rgba(28, 139, 230, 0.7)", borderRadius: "10px" }}>
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      onChange={(e) => setNameToUpdate({ ...nameToUpdate, [product._id]: e.target.value })}
                    />
                  </div>
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      onChange={(e) => setPriceToUpdate({ ...priceToUpdate, [product._id]: parseFloat(e.target.value) })}
                    />
                  </div>
                  <button className="btn btn-primary btn-sm" onClick={() => handleUpdateProduct(product._id)}>
                    Update Product
                  </button>
                </div>
              </div>
