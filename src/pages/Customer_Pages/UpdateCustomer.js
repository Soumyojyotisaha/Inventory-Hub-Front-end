...
function UpdateCustomer() {
  ...
  useEffect(() => {
    ...
    axios.get("https://inventory-management-rest-api-mongo-db.onrender.com/api/customers/profile", {
      headers: {
  ...
  const handleUpdateProfile = () => {
    ...
    axios.put("https://inventory-management-rest-api-mongo-db.onrender.com/api/customers/profile", updatedUser, {
      headers: {
        Authorization: `Bearer ${token}`
      }
    })
